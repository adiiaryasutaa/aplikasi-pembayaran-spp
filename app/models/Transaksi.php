...
class Transaksi extends Model
{
	...
	public function allHistoryForPetugas(array $columns)
	{
		...
		$query = sprintf(
			...
			'transaksi.id, transaksi.tanggal_dibayar, transaksi.bulan_dibayar, transaksi.tahun_dibayar, pembayaran.tahun_ajaran, siswa.nis',
			'transaksi',
			'pembayaran',
			'pembayaran.id = transaksi.pembayaran_id',
			'siswa',
	...
	public function allHistoryForSiswa(array $columns)
	{
		$values = array_values($columns);
		$columns = array_keys($columns);
		$bindings = QueryHelper::makeColumnBindings($columns);
